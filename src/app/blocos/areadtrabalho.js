...
export default function Areadtrabalho() {
    ...
    const handleCreateBlock = async () => {
        ...
        setBlockName('');
        setSelectedColor('#4B6D9B'); // Resetar cor selecionada após criação
        setModalVisible(false);
        ...
        await saveBlockColor(blockName, selectedColor); // Salvar a cor selecionada para o novo bloco no AsyncStorage
    };
